...
public class deny extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int a = newID.getstudentID();
        String b = request.getParameter("id");
        user1 = a;
        user2 = Integer.parseInt(b);
        //String q1 = "insert into people_helper (user_id, helper_id) values ("+user1+","+user2+")";
        String q2 = "delete from friend where user_1="+user2+" and "+"user_2="+user1;
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet deny</title>");            
            out.println("</head>");
            out.println("<body>");
            //out.println(u);
            out.println(user1);
            out.println(user2);
            out.println("<h1>Servlet deny at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(deny.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
