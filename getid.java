...
public class getid extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        a = newID.getstudentID();
        request.setAttribute("id", a);
        RequestDispatcher rd = getServletContext().getRequestDispatcher("/add_friend.jsp");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet getid</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println(a);
            out.println("<h1>Servlet getid at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
